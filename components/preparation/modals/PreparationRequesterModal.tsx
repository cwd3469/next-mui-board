...
interface PreparationRequesterModalType extends ModalType {
  id: string;
}

const PreparationRequesterModal = (props: PreparationRequesterModalType) => {
...
export default PreparationRequesterModal;
